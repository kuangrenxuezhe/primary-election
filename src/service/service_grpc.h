  ...
  namespace recmd {
    ...
    class ServiceGrpc: public PrimaryElection::Service {
      ...
      public:
        ...
        virtual grpc::Status updateAction(grpc::ServerContext* context, const Action* request, StatusCode* response);
        virtual grpc::Status deleteUserDislike(grpc::ServerContext* context, const UserProfileFieldKey* request, StatusCode* response);
