...
public:
    ...
    // for algorithm: type(var_4, no_use), history_num(var_4), history_list(var_u8 * history_num), type(var_4, no_use), clicktime(var_4), user_id(var_u8), doc_id(var_u8), staytime(var_4), action(var_4), location_len(var_4), location(location_len), srpid_len(var_4), srpid(srpid_len)
    // for candidate: type(var_4, no_use), clicktime(var_4), user_id(var_u8), doc_id(var_u8), staytime(var_4), action(var_4), location_len(var_4), location(location_len), srpid_len(var_4), srpid(srpid_len)
    ...
    virtual var_4 query_recommend(var_u8 user_id, var_4 flag, var_1* result_buf, var_4 result_max, var_4& result_len) { return -999; }
